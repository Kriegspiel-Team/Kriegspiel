...
@Test(expected = BoardFileFormatException.class)
				...
				\begin{figure}[!h]
				    ...
				    \centering
				    \includegraphics[width=\textwidth]{images/tests_unitaires/entityloader.png}
				\end{figure}
		...
		\subsection{Tests fonctionnels}
			...
			\subsubsection{Chargement d'un fichier incorrect}
				...
				\begin{figure}[!h]
				    ...
				    \centering
				    %\includegraphics[width=\textwidth]{images/tests_fonctionnels/incorrect_file.ps}
				\end{figure}
			...
			\subsubsection{Représentation d'une situation}
				...
				\begin{figure}[!h]
				    ...
				    \centering
				    %\includegraphics[width=\textwidth]{images/tests_fonctionnels/representation_situation.ps}
			...
			\subsubsection{Affichage de la zone d'influence}
				...
				\begin{figure}[!h]
				    ...
				    \centering
				    %\includegraphics[width=\textwidth]{images/tests_fonctionnels/zone_influence.ps}
