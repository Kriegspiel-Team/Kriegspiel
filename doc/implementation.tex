		...
		\subsection{Tests fonctionnels}
			...
			\subsubsection{Chargement d'un fichier incorrect}
				...
				\begin{figure}[!h]
				    ...
				    \centering
				    \centerline{\includegraphics[scale=0.4]{images/tests_fonctionnels/incorrect_file.png}}
				\end{figure}
			...
			\subsubsection{Représentation d'une situation}
				...
				\begin{figure}[!h]
				    ...
				    \centerline{\includegraphics[scale=0.4]{images/tests_fonctionnels/representation_situation.png}}
			...
			\subsubsection{Affichage de la zone d'influence}
				...
				\begin{figure}[!h]
				    ...
				    \centerline{\includegraphics[scale=0.4]{images/tests_fonctionnels/zone_influence.png}}
